...
function fetch_populate(apiUrl) {
    ...
    fetch(apiUrl)
        ...
        .then(data => {
            ...
            switch (symbol) {
                case `IBM`:
                    document.querySelector(`#companyName`).innerHTML = `International Business Machines Co.`;
                    break;
                case `AAPL`:
                    document.querySelector(`#companyName`).innerHTML = `Apple Inc.`;
                    break;
                case `TSLA`:
                    document.querySelector(`#companyName`).innerHTML = `Tesla Inc.`;
                    break;
                case `AMZN`:
                    document.querySelector(`#companyName`).innerHTML = `Amazon Inc.`;
                    break;
                case `WMT`:
                    document.querySelector(`#companyName`).innerHTML = `Walmart Inc.`;
                    break;
                case `MSFT`:
                    document.querySelector(`#companyName`).innerHTML = `Microsoft Corp.`;
                    break;
                case `KO`:
                    document.querySelector(`#companyName`).innerHTML = `KO`;
                    break;
                case `NFLX`:
                    document.querySelector(`#companyName`).innerHTML = `Netflix Inc.`;
                    break;
                case `META`:
                    document.querySelector(`#companyName`).innerHTML = `Meta Platforms Inc.`;
                    break;
                case `F`:
                    document.querySelector(`#companyName`).innerHTML = `Ford Motors Co.`;
                    break;
            }
